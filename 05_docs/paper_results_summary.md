...
This run completed a full DAppSCAN experiment sweep across four vulnerability tasks and generated 216 result files. The strongest method under uniform false-negative noise is RESCUER with an overall average F1 of 0.4560. Under asymmetric noise, the best overall method is CL with an average F1 of 0.4594. In the ablation study, the full model reaches an average F1 of 0.4229.
